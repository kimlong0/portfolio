        ...
        <div className="flex flex-col sm:flex-row">
            <div className="flex flex-col justify-around items-center basis-1/2 h-128 py-20 px-20 m-1 bg-slate-800 rounded-5xl text-white" id="About">
                <div className="flex flex-col">
                    <h3 className="text-xl md:text-2xl font-medium">Finance & Information Systems student at the University of Washington.</h3>
            ...
            <div className="flex flex-col h-128 basis-1/2 m-1">
                ...
                <div className="flex flex-col md:flex-row justify-center items-center h-64 w-full bg-[#FDD819] mt-1 rounded-5xl">
                    <h2 className="text-3xl font-bold m-4">Some of my Projects</h2>
