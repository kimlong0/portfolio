...
function About() {
    return (
        <div className="flex flex-col sm:flex-row gap-2 mt-2">
            <div className="flex flex-col justify-around items-center basis-1/2 h-128 py-20 px-20 bg-slate-800 rounded-5xl text-white" id="About">
            ...
            <div className="flex flex-col h-128 basis-1/2 gap-2">
                <div className="flex flex-col justify-center items-center h-64 w-full bg-[#3DC7E7] rounded-5xl text-black">
